...
#         }
#     )
#     # 대화는 최대 10개 미만으로 하며 오래된 항목부터 지운다.
#     if len(history) > 10 :
#         history.pop(0)


# # 대화 가져오기 함수
# # 최근 대화 기록을 순회를 하며 에이전트의 새로운 프롬프트를 갱신하여
# # 에이전트가 대화를 계속 이어나갈 수 있게끔 한다
...
class ChatBotCrew:
    def create_agent(self) -> Agent:
        return Agent(
            ...
            **중요** : 위 대화 기록을 참고를 해서 이전 질문들을 기억하고 개인화된 답변을 제공하세요.
            """,
    ...
    def communication_task(self) -> Task:
        return Task(
            ...
            4. 마크다운 문법을 쓰지 않고 직관적으로 이모티콘을 섞어 생성합니다.
            """,
            expected_output="""
